...
public class ClassifierDemo
	...
	protected SupervisedFeedForwardNeuralNetwork createSupervisedNeuralNetwork(int featureCount) {
		...
		FeedForwardLayer<?, ?> secondLayer = new FullyConnectedFeedForwardLayerImpl(directedComponentFactory,
				axonsFactory, new Neurons3D(20, 20, 1, true), new Neurons(10, false),
				new DefaultSoftmaxActivationFunctionImpl(), matrixFactory, false);
	...
	protected FeedForwardNeuralNetworkContext createTrainingContext(
		...
		FeedForwardNeuralNetworkContext context = new FeedForwardNeuralNetworkContextImpl(matrixFactory, true);
	...
	protected void showcaseTrainedNeuralNetworkOnTrainingSet(SupervisedFeedForwardNeuralNetwork neuralNetwork,
		...
		// new FeedForwardNeuralNetworkContextImpl(matrixFactory, 0, null);
		FeedForwardNeuralNetworkContext accuracyContext = new FeedForwardNeuralNetworkContextImpl(matrixFactory, false);
	...
	protected void showcaseTrainedNeuralNetworkOnTestSet(SupervisedFeedForwardNeuralNetwork neuralNetwork,
		...
		for (int i = 0; i < 100; i++) {
			...
			FeedForwardNeuralNetworkContext classifyingContext = new FeedForwardNeuralNetworkContextImpl(matrixFactory,
					false);
