...
public abstract class SupervisedNeuralNetworkDemoBase<N 
  ...
  public void runDemo() throws Exception {
    ...
    DirectedComponentsContext directedComponentsContext = new DirectedComponentsContextImpl(matrixFactory, false);
    ...
    N supervisedNeuralNetwork =
        createSupervisedNeuralNetwork(inputFeatureCount, directedComponentsContext);

    // Create the training context
    C trainingContext = createTrainingContext(supervisedNeuralNetwork, directedComponentsContext.asTrainingContext());
    ...
    showcaseTrainedNeuralNetworkOnTrainingSet(supervisedNeuralNetwork, 
        trainingDataInputActivations, trainingLabelOutputActivations, directedComponentsContext.asNonTrainingContext());
    ...
    showcaseTrainedNeuralNetworkOnTestSet(supervisedNeuralNetwork, 
        testSetInputActivations, testSetLabelActivations, directedComponentsContext.asNonTrainingContext());
  }
   ...
   */
  protected abstract NeuronsActivation createTrainingLabelNeuronActivations(
      MatrixFactory matrixFactory);
   ...
   */
  protected abstract NeuronsActivation createTestSetLabelNeuronActivations(
      MatrixFactory matrixFactory);
 ...
 * @param directedComponentsContext 
   ...
   */
  protected abstract N createSupervisedNeuralNetwork(int featureCount, DirectedComponentsContext directedComponentsContext);
   ...
   * @param directedComponentsContext The training DirectedComponentsContext we are using for this demo
   ...
   * @param directedComponentsContext The DirectedComponentsContext we are using for this demo
   ...
   * @param testDataInputActivations The input NeuronsActivation instance generated by the test data
   * @param testSetLabelActivations The labels NeuronsActivation instance generted by the test set
   * @param directedComponentsContext The DirectedComponentsContext we are using to showcase the demo
   * @throws Exception In the event of an exception
   */
