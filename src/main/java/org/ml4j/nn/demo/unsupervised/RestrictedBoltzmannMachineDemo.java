...
public class RestrictedBoltzmannMachineDemo
	...
	protected RestrictedBoltzmannMachineContext createTrainingContext(
		...
		RestrictedBoltzmannMachineContext context = new RestrictedBoltzmannMachineContextImpl(matrixFactory, true);
	...
	protected void showcaseTrainedNeuralNetwork(RestrictedBoltzmannMachine restrictedBoltzmannMachine,
		...
		RestrictedBoltzmannMachineContext samplingContext = new RestrictedBoltzmannMachineContextImpl(matrixFactory,
				false);
		...
		for (int j = 0; j < restrictedBoltzmannMachine.getLayer().getHiddenNeurons()
			...
			UndirectedLayerContext hiddenNeuronInspectionContext = new UndirectedLayerContextImpl(0, matrixFactory,
					false);
			NeuronsActivation neuronActivationMaximisingActivation = restrictedBoltzmannMachine.getLayer()
					.getOptimalVisibleActivationsForHiddenNeuron(j, hiddenNeuronInspectionContext, matrixFactory);
			...
			RestrictedBoltzmannSamplingActivation samplingResult = restrictedBoltzmannMachine
					.performGibbsSampling(
							new NeuronsActivationImpl(new Neurons(visibleActivations.getRows(), false),
									visibleActivations, NeuronsActivationFeatureOrientation.ROWS_SPAN_FEATURE_SET),
							500, samplingContext);
